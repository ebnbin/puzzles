...
// 先 2048 再缩:tiles 是 256 的像素画,8x 整数放大且 smoothing off;缩到 512 时 4x4 平均恰好整落在
// 8x8 块内。改 CANVAS 必须保持这套整除关系。
const CANVAS = 2048

// 四个都出正方形、不自带圆角:iOS/Android 都会按自己的形状再裁一次(manifest 的 purpose 是
// "any maskable")。
const SIZES = [
