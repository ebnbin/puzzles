          ...
          >
            ...
            */}
            {acts.map((cursor, i) => {
               ...
               *
               * Hidden rather than unmounted, which is not a nicety: taking them
               * out and putting them back is what leaves a button drawn as a
               * fragment of itself on iOS. `visibility` keeps the box laid out
               * in the cell it already had, so disarming flips a paint flag and
               * moves nothing. See `[data-off]` in index.css.
               */
