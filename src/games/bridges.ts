...
import { CAP, int, ordinal, range } from './util/params'
...
const bridges: Game = {
  ...
  types: {
    ...
    params: [
      ...
      // 上游用下拉装的三个数值阶梯,画成滑块;写回的仍是选项下标。
      ordinal('Max. bridges per direction'),
      ordinal('%age of island squares'),
      ordinal('Expansion factor (%age)'),
    ],
  },
