...
// validate_params flip.c:189-198,不看 full:宽高 > 0;两条 INT_MAX 在 100 以内碰不到。
// 生成期多一条:随机形状下 1×2 / 2×1 必然死循环——候选格恰好等于配额(flip.c:414),
// 全部加进去之后两行矩阵必相同,上游查到相同行就整个重来(flip.c:531-540),没有随机性
