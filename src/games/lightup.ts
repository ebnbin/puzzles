...
// validate_params lightup.c:355-374:宽高 ≥ 2;full 下黑格百分比 5..100(362),4 重旋转
// 只许正方形(365-367),4 重对称宽高至少一维 ≥ 3(369)。INT_MAX 那条在 100 以内碰不到。
// 百分比只是提示,生成器造不出来会自己往上加(lightup.c:1609);难度是等到低一档解法
// 解不动为止的概率重试。
const ROT4 = 4
const REF4 = 3
const custom: Custom = {
  ...
  rules: [
    ...
    rule('lightup.c:369', ['w', 'h', 'symm'], (v) => (v.symm === ROT4 || v.symm === REF4) && v.w < 3 && v.h < 3),
  ],
}
